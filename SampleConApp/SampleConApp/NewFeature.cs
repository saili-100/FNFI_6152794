using CollectionAssignment.UILayer;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;
using System.Threading.Tasks;
// var kryword anonymous types,methods,lambda Functions and expressions
namespace SampleConApp
{
    internal class NewFeature
    {
        ...
        //private static void LambdaFunctionExample()
        //{
        ...
        {
            var temp = new { Name = "Saili", Address = "Banglore", Pincode = 560027 };
            Console.WriteLine($"The values are {temp.Name} is from {temp.Address}");
            Console.WriteLine("the datatype of variable temp is " + temp.GetType().Name) ;
        }
