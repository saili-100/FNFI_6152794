...
// repo was accessed using Get enumerator and it has some methods that's why interface is used .
// iterator for internal working.
namespace SampleConApp.CustomCollections
{
    ...
    internal class CustomCollections
    {
        static void Main(string[] args)
        {
            ...
            string menu = """
                ...
                NOTE: TO EXIST PRESS ANY OTHER KEY
